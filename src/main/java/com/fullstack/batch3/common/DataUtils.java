...
public class DataUtils {
	...
	static String environment = System.getProperty("environment") == null ? "staging" : System.getProperty("environment");
	static String testDataFile = environment.equals("staging") ? "TestDataStage.xlsx" : "TestDataProd.xlsx";
